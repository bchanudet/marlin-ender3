...
#define STRING_CONFIG_H_AUTHOR "(bchanudet, Ender-3)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 5, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -5, -0.4 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  150, 0, 12 } }
  #define NOZZLE_CLEAN_END_POINT   { { 190, 0, 12 } }
